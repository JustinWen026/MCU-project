...
int lastRead;
# 28 "main.c"
long long xFiltered = 0;
long long yFiltered = 0;
...
void rotateTo(int pwm, int deg) {
    if(pwm == 1){
        long pulse_width = (long)deg * (2400 - 400) / 180 + 400;
        int duty_cycle = pulse_width / (1 * 16);
...
void readX() {
    ...
    int adcRead = (ADRESH*256) | (ADRESL);
# 222 "main.c"
        char value[20];
        sprintf(value, "%d", adcRead);
